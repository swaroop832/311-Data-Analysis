      ...
      $scope.kcfunction = function () {
          ...
          $scope.kcfunction1 = function (selected_year) {
              ...
              $http.get("https://data.kcmo.org/resource/cyqf-nban.json?$limit=15&creation_year=" + selected_year + "&$select=category,count(case_id)&$group=category&$order=count(case_id) DESC").then(function (response) {
                  ...
                  $scope.kc_category_1 = parseInt($scope.kcvalue[0].category);
                  $scope.kc_category_2 = parseInt($scope.kcvalue[1].category);
                  $scope.kc_category_3 = parseInt($scope.kcvalue[2].category);
                  $scope.kc_category_4 = parseInt($scope.kcvalue[3].category);
                  $scope.kc_category_5 = parseInt($scope.kcvalue[4].category);
                  $scope.kc_category_6 = parseInt($scope.kcvalue[5].category);
                  $scope.kc_category_7 = parseInt($scope.kcvalue[6].category);
                  $scope.kc_category_8 = parseInt($scope.kcvalue[7].category);
                  $scope.kc_category_9 = parseInt($scope.kcvalue[8].category);
                  $scope.kc_category_10 = parseInt($scope.kcvalue[9].category);
                  $scope.kc_category_11 = parseInt($scope.kcvalue[10].category);
                  $scope.kc_category_12 = parseInt($scope.kcvalue[11].category);
                  $scope.kc_category_13 = parseInt($scope.kcvalue[12].category);
                  $scope.kc_category_14 = parseInt($scope.kcvalue[13].category);
                  $scope.kc_category_15 = parseInt($scope.kcvalue[14].category);
...
// Los Angeles, CA
    ...
    function drawChartkc2(var0, var1 , var2, var3, var4, var5, var6, var7, var8,
        ...
        var data = google.visualization.arrayToDataTable([
            ...
            [$scope.var0, parseInt($scope.var15)],
            [$scope.var1, parseInt($scope.var16)],
            [$scope.var2, parseInt($scope.var17)],
            [$scope.var3, parseInt($scope.var18)],
            [$scope.var4, parseInt($scope.var19)],
            [$scope.var5, parseInt($scope.var20)],
            [$scope.var6, parseInt($scope.var21)],
            [$scope.var7, parseInt($scope.var22)],
            [$scope.var8, parseInt($scope.var23)],
            [$scope.var9, parseInt($scope.var24)],
            [$scope.var10, parseInt($scope.var25)],
            [$scope.var11, parseInt($scope.var26)],
            [$scope.var12, parseInt($scope.var27)],
            [$scope.var13, parseInt($scope.var28)],
            [$scope.var14, parseInt($scope.var29)]
        ]);
        var options = {
            title: 'Category',
